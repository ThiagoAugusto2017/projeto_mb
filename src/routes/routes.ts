...
import {
	...
	eventoValidetion,
	costsValidetion,
} from '../middleware/cadastroValidation';
...
router.patch('/api/usuario', cadastroValidation, authorization.verifyToken, InputUsuario.usuarioEdt);

router.post('/api/evento', eventoValidetion, authorization.verifyToken, Evento.inputEvento);
...
router.post('/api/evento/:id/costs/', costsValidetion, authorization.verifyToken, Costs.inputCosts);
